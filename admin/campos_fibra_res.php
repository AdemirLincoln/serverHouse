	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">Edições dos Planos Fibra Óptica Residenciais</h3>
				...
				<div class="page-bar">
					...
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="#">Edições dos Planos Fibra Óptica Residenciais</a>
						</li>
					</ul>
				...
				<div class="row">			
                	...
                	<?php if (isset($_GET) && $_GET['id'] != ""): ?>
	                		...
	                		$idstal = $_GET['id'];
						   	...
						   	$consulta = "SELECT * FROM planos
										 INNER JOIN planos_itens ON planos_itens.id_planos = planos.id 
						   				 WHERE planos.id = '$idstal' AND planos.tipo = 'fr'";
                		...
                		<form action="gravarDadosAdmin.php" method="POST" role="form">
	                		...
	                		<?php foreach ($coisas as $key => $value): ?> 
							
							<input type="hidden" name="tipo" value="fr">
