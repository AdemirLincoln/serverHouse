	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				...
				<!-- BEGIN PAGE HEADER-->
				<h3 class="page-title">Edições dos Planos Fibra Óptica Empresariais</h3>
				...
				<div class="page-bar">
					...
					<ul class="page-breadcrumb">
						...
						<li>
							<a href="#">Edições dos Planos Fibra Óptica Empresariais</a>
						</li>
					</ul>
						...
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
	                        <div class="box-shadow">
	                            ...
	                            <div class="try">
	                                ...
	                                <a href="campos_fibra_emp.php?id=<?php echo $value['id_planos'] ?>"  class="btn btn-danger">Editar</a>
	                            </div>
	                        </div>
	                    </div>
