...
INSERT INTO `clientes` (`id`, `nome`, `responsavel`, `empresa`, `rg`, `cpf`, `cnpj`, `email`, `endereco`, `numero`, `celular`, `telefone`, `estado`, `cidade`, `data`) VALUES
(20, 'Vinicius', '', '', '123456-78', '123.456.789-12', '', 'vinicius.marinho@outlook.com', 'Rua Tal Tal', '1234', '(45) 9878-6545', '(45) 3221-6554', 'PARANÁ', 'CASCAVEL', '0000-00-00 00:00:00'),
(21, 'dfdgfg', '', '', 'fgdfgd', '45.563.543-53', '', 'vinicius.marinho@outlook.com', 'dfdfgfdfdg', '45556', '(54) 5654-6456', '(54) 6455-6445', 'ACRE', 'ASSIS BRASIL', '2015-10-06 18:29:03'),
(22, 'Jorge', '', '', '123123123', '231.231.233-12', '', 'teste@msn.com', 'Rua Tal Tal', '23432', '(45) 9887-6554', '(45) 3221-6554', 'PARANÁ', 'CORBÉLIA', '2015-10-08 21:41:43');
...
INSERT INTO `login` (`idUsuario`, `login`, `senha`) VALUES
(1, 'admin', 'cli007');
...
INSERT INTO `planos` (`id`, `descricao`, `tipo`, `status`, `preco`) VALUES
(17, 'Plano talbvnvbvbv', 'wr', 'ATV', 'Plano talcdscddscsdcddds'),
(19, 'Plano 90MB', 'wr', 'ATV', 'Plano 90MB'),
(20, 'plano 20vdffvfddvf', 'wr', 'ATV', 'plano 20dfvdf'),
(21, 'plano 205', 'wr', 'ATV', 'plano 205'),
(22, 'plano 205', 'wr', 'ATV', 'plano 205'),
(23, 'Plano tal', 'we', 'ATV', 'Plano tal'),
(24, 'Plano 90MB', 'we', 'ATV', 'Plano 90MB'),
(25, 'plano 20vdffvfddvf', 'we', 'ATV', 'plano 20dfvdf'),
(26, 'plano 205xzcxzc', 'we', 'ATV', 'plano 205'),
(27, 'plano 205', 'we', 'ATV', 'plano 205'),
(28, 'Residencial 2mb', 'fr', 'ATV', 'R$: 99,90'),
(29, 'Plano 90MB', 'fr', 'ATV', 'Plano 90MB'),
(30, 'plano 20vdffvfddvf', 'fr', 'ATV', 'plano 20dfvdf'),
(31, 'plano 205', 'fr', 'ATV', 'plano 205'),
(32, 'plano 205', 'fr', 'ATV', 'plano 205'),
(33, 'Plano tal', 'fe', 'ATV', 'Plano talc x xc cx '),
(34, 'Plano 90MB', 'fe', 'ATV', 'Plano 90MBfvdvfddv'),
(35, 'plano 20vdffvfddvf', 'fe', 'ATV', 'plano 20dfvdf'),
(36, 'plano 205xzcxzc', 'fe', 'ATV', 'plano 205'),
(37, 'plano 205', 'fe', 'ATV', 'plano 205');

-- --------------------------------------------------------

--
-- Table structure for table `planos_itens`
--

CREATE TABLE `planos_itens` (
`id` int(11) NOT NULL,
  `id_planos` int(20) NOT NULL,
  `campo1` varchar(255) NOT NULL,
  `campo2` varchar(255) NOT NULL,
  `campo3` varchar(255) NOT NULL,
  `campo4` varchar(255) NOT NULL,
  `campo5` varchar(255) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `planos_itens`
--

INSERT INTO `planos_itens` (`id`, `id_planos`, `campo1`, `campo2`, `campo3`, `campo4`, `campo5`) VALUES
(15, 17, 'Plano talvcnbvn', 'Plano tal', 'Plano talbvnvcv', 'Plano tal', 'Plano tal'),
(17, 19, 'Plano 90MB', 'Plano 90MB', 'Plano 90MB', 'Plano 90MB', 'Plano 90MB'),
(18, 20, 'plano 20vdvfv', 'plano 20dvfvfv', 'plano 20dvfvvdvf', 'plano 20vdffv', 'plano 20ddvdffvdfv'),
(19, 21, 'plano 205', 'plano 205', 'plano 205', 'plano 205', 'plano 205'),
(20, 22, 'plano 205', 'plano 205', 'plano 205', 'plano 205', 'plano 205'),
(23, 23, 'Plano tal', 'Plano tal', 'Plano tal', 'Plano tal', 'Plano tal'),
(24, 24, 'Plano 90MB', 'Plano 90MB', 'Plano 90MB', 'Plano 90MB', 'Plano 90MB'),
(25, 25, 'plano 20vdvfv', 'plano 20dvfvfv', 'plano 20dvfvvdvf', 'plano 20vdffv', 'plano 20ddvdffvdfv'),
(26, 26, 'xzplano 205cxzc', 'plano 205', 'plano 205cxzc', 'plano 205', 'plano 205xzcx'),
(27, 27, 'plano 205', 'plano 205', 'plano 205', 'plano 205', 'plano 205'),
(28, 28, 'Download: 2 Mega', 'Upload: 2 Mega', 'ConexÃ£o ilimitada', 'IP Fixo: NÃ£o incluso(ip Fixo + R$10,00)', 'Taxa de instalaÃ§Ã£o R$ 350,00 e equipamento em comodato'),
(29, 29, 'Plano 90MB', 'Plano 90MB', 'Plano 90MB', 'Plano 90MB', 'Plano 90MB'),
(30, 30, 'plano 20vdvfv', 'plano 20dvfvfv', 'plano 20dvfvvdvf', 'plano 20vdffv', 'plano 20ddvdffvdfv'),
(31, 31, 'plano 205', 'plano 205', 'plano 205', 'plano 205', 'plano 205'),
(32, 32, 'plano 205', 'plano 205', 'plano 205', 'plano 205', 'plano 205'),
(33, 33, 'Plano tal', 'Plano tal', 'Plano tal', 'Plano tal', 'Plano tal'),
(34, 34, 'Plano 90MB', 'Plano 90MB', 'Plano 90MB', 'Plano 90MB', 'Plano 90MB'),
(35, 35, 'plano 20vdvfv', 'plano 20dvfvfv', 'plano 20dvfvvdvf', 'plano 20vdffv', 'plano 20ddvdffvdfv'),
(36, 36, 'xzplano 205cxzc', 'plano 205', 'plano 205cxzc', 'plano 205', 'plano 205xzcx'),
(37, 37, 'plano 205', 'plano 205', 'plano 205', 'plano 205', 'plano 205');
...
--
-- Indexes for table `planos_itens`
--
...
--
-- AUTO_INCREMENT for table `planos_itens`
--
ALTER TABLE `planos_itens`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;